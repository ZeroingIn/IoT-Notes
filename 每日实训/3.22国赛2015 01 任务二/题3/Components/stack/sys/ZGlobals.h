 ...
 */
   ...
   #define ZG_BUILD_COORDINATOR_TYPE  (0)
    ...
    #define ZG_BUILD_ENDDEVICE_TYPE    ( DEVICE_BUILD_ENDDEVICE)
    #define ZG_BUILD_RTRONLY_TYPE      (0)
    #define ZG_BUILD_JOINING_TYPE      ( DEVICE_BUILD_ENDDEVICE)
    #define ZG_DEVICE_JOINING_TYPE     (1)
    
    #define ZSTACK_ROUTER_BUILD           1
   #define ZSTACK_END_DEVICE_BUILD     1
   #define ZG_DEVICE_RTR_TYPE 0
   #define ZG_DEVICE_COORDINATOR_TYPE 0
#else 
