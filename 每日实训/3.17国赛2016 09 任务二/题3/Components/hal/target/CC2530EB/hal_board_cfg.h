...
/* ----------- LED's ---------- */
    ...
    /* DC1*/
#define DC1_BV           BV(0)
#define DC1_SBIT         P2_0
#define DC1_DDR          P2DIR
#define DC1_POLARITY     ACTIVE_HIGH
/* DC2*/
#define DC2_BV           BV(7)
#define DC2_SBIT         P1_7
#define DC2_DDR          P1DIR
#define DC2_POLARITY     ACTIVE_HIGH
#define HAL_TURN_OFF_DC1()       st( DC1_SBIT = DC1_POLARITY (0); )
#define HAL_TURN_OFF_DC2()       st( DC2_SBIT = DC2_POLARITY (0); )
#define HAL_TURN_ON_DC1()       st( DC1_SBIT = DC1_POLARITY (1); )
#define HAL_TURN_ON_DC2()       st( DC2_SBIT = DC2_POLARITY (1); )
#define HAL_TOGGLE_DC1()         st( if (DC1_SBIT) { DC1_SBIT = 0; } else { DC1_SBIT = 1;} )
#define HAL_TOGGLE_DC2()         st( if (DC2_SBIT) { DC2_SBIT = 0; } else { DC2_SBIT = 1;} )
#define HAL_STATE_DC1()          (DC1_POLARITY (DC1_SBIT))
#define HAL_STATE_DC2()          (DC2_POLARITY (DC2_SBIT))
  ...
  #define HAL_STATE_LED4()          (LED4_POLARITY (LED3_SBIT))
